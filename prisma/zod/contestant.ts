...
import { CompleteUser, relatedUserModel, CompleteContest, relatedContestModel, CompleteVote, relatedVoteModel } from "./index"
 ...
 */
export const relatedContestantModel: z.ZodSchema<CompleteContestant> = z.lazy(() => contestantModel.extend({
